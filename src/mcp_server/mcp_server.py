...
import gradio as gr
from src.core.main import get_app
...
class EcoAgentMCP:
    ...
    def call_tool(self, request: CallToolRequest) -> CallToolResponse:
        """Execute a tool call following MCP protocol."""
            ...
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    **To connect MCP clients:**
                    ...
                    2. Clients will auto-discover all available sustainability tools
...
def main():
    ...
    print("This Gradio app can be used as an MCP server for sustainability tools.")
